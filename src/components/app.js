            ...
            <div className="container">
                <div className="card text-left mb-4">
                    ...
                    <div className="purchase form-group"> 
                        ...
                        <input className="form-control" type="text" placeholder="Nombre del Proyecto" onChange={(e) => this.updateValue("purchase", "projectName", e.target.value)}/>
                        <br></br>
                        ...
                        <br></br> 
                        <a className="form-text text-muted" target="_blank" href={this.explorerUrl + "/tx/" + this.state.purchase.dataid}>Transaction / Total a Pagar: {(100-this.state.purchase.userDiscount)*this.state.purchase.orderQty*1*this.wavelet/100}</a>
                        <br></br>
